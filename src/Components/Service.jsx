...
const Service = () => {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div className="max-w-screen-md mb-8 lg:mb-16">
          ...
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">At AS'S blog, we cover a wide range of topics tailored to diverse interests. Whether you’re looking for the latest trends, in-depth analysis, or practical advice, we’ve got you covered. Our categories include:

Technology: Stay updated with the newest advancements, gadget reviews, and tech tips.
Lifestyle: Discover articles on wellness, travel, personal development, and more.
Entertainment: Dive into movie reviews, celebrity news, and pop culture insights.
Business: Get expert opinions, industry news, and strategies to drive your success.</p>
      </div>
